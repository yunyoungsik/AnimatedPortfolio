...
const AboutPage = () => {
  ...
  return (
    ...
    >
      {/* container */}
      <div className="scrollbar-hide h-full overflow-y-scroll lg:flex" ref={containerRef}>
        {/* text container */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* biography desc */}
            <p className="text-lg">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, optio obcaecati!
              Asperiores perspiciatis harum mollitia labore maiores fugit explicabo eos officiis
              minima odit, iusto ipsa aut at cupiditate quaerat fugiat.
            </p>
            {/* biography quote */}
          ...
          <div className="flex flex-col gap-12 justify-center pb-48" ref={experienceRef}>
            ...
            <motion.div initial={{ x: '-300px' }} animate={isExperienceRefInview ? { x: '0' } : {}}>
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3">
                  {/* job title */}
                  <div className="p-3 bg-white font-semibold rounded-b-lg rounded-s-lg">
                    Frontend Engineer
                  </div>
                  {/* job desc */}
        ...
        {/* svg container */}
        <div className="hidden sticky top-0 lg:block w-1/3 xl:w-1/2 z-30">
